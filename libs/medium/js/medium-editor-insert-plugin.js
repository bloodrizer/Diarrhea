...
;(function ($, window, document, undefined) {
    ...
    function Core(el, options) {
        ...
        console.log("window dump:", window, MediumInsert);
...
; (function ($, window, document, Util, undefined) {
    ...
    Images.prototype.add = function () {
		...
		console.log("starting file upload, file container is:", $file);
		var opts = $.extend(true, {}, this.options.fileUploadOptions, fileUploadOptions);
		console.log("file upload opts are:", opts);
        $file.fileupload(opts);

        $file.click();*/
        
        // I've just butchered all this stuff to secretly sneak a callback
        
        var handler = this.options.uploadHandler;
        if (!handler){
			throw "Upload handler must be provided, SORYAN";
		}
		console.log("calling upload hanlder:", handler);
		$.proxy(handler, this, $file)();
